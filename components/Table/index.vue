<template>
  ...
  <div>
    <table class="contentTable">
      ...
      <tbody class="contentSection">
        <tr class="bottomLine">
          <td class="smallColumn">  <img class="iconSmall" src="../../resources/icons/garbage.svg" /></td>
            <td class="bigColumn" >
            ...
            <td class="bigColumn">
              <div class="quantityCounter">
                <button class="subtraction" >-</button><p class="quantity">01</p><button class="multiplication">+</button>
              </div>
            </td>
            <td class="bigColumn"> <b>R$ 1.500,00</b>  à vista <br /> ou 10x R$ 150,00</td>
            <td class="mediumColumn"><b>R$ 1.500,00</b>  à vista <br /> ou 10x R$ 150,00</td>        
        </tr>
  ...
  <div class="finalPrice bottomLine">
          <div class="cashPayment">
            <p>Total à Vista</p> <span>R$ 1.500,00</span><br />
          </div>
          <div class="paymentInstallments">
            <p>Total Parcelado</p> <span>em até <b>10 x R$ 150,00</b> <br />(Total R$ 1.500,00)</span>
          </div>
    </div>
      <div class="checkout" >
